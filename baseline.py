...
places_list = sorted(places.keys())
...
fres_rep.close()
fres_dem.close()
print 'Correct = ' + str(correct) + ' | Wrong = ' + str(wrong) + ' | Accuracy = ' + str((correct * 100.0) / (correct + wrong)) + ' | MAE = ' + str(tot_mae / tot_mae_count) + ' | Accuracy rep = ' + str((correct_rep * 100.0) / (correct_rep + wrong_rep))  + ' | Accuracy dem = ' + str((correct_dem * 100.0) / (correct_dem + wrong_dem)) 
